...
export const MESSAGE_ZH=Object.freeze({
  ...
  'You found the old motor. Reach the rain at the exit.':'找到了老式电机。现在去雨声处按 E 逃脱。',
  'The old motor is not within reach.':'老式电机还不在附近，继续循声寻找。',
  'Reach the rain and interact to escape.':'循着雨声找到出口，按 E 逃脱。',
  ...
  'Listen for the survivor heartbeat. Get close and interact to catch the survivor.':'循着心跳声接近求生者，靠近后按 E 抓捕。',
