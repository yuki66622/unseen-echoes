...
export const MESSAGE_ZH=Object.freeze({
  ...
  'Wait for the head start, then listen for footsteps.':'等待求生者先行时间结束，再循着脚步声追捕。',
  ...
  'Open the exit door before escaping.':'先按 F 打开出口，再按 E 逃脱。',
  'Find the old motor, then reach the rain at the exit.':'循着机械运转声找到老式电机，再去雨声处寻找出口。',
  'Find the old motor and interact to inspect it.':'循着机械运转声找到老式电机，靠近后按 E 确认。',
  'You found the old motor. Reach the rain at the exit.':'找到了老式电机。现在去雨声处开门逃脱。',
  'The old motor is not within reach.':'老式电机还不在附近，继续循声寻找。',
  'Reach the rain, open the exit door, then interact to escape.':'循着雨声找到出口，按 F 开门，再按 E 逃脱。',
  ...
  'Listen for footsteps. Get close and interact to catch the survivor.':'循着脚步声接近求生者，靠近后按 E 抓捕。',
  'Reach the rain beyond the door and interact to escape.':'前往门后的雨声处，靠近后按 E 逃脱。',
  'Find the birds and interact to collect the key.':'循着鸟鸣找到钥匙，靠近后按 E 拾取。',
