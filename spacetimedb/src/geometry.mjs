// Empty square play area, no physical walls or doors. Tutorial is separate.
...
// Legacy DOOR export is an exit landmark for older clients, never a collider.
// Movement is bounded to the play area independently of physical geometry.
...
export function blockingSegments(_doorOpen=false) { return WALLS; }
